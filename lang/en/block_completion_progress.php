...
$string['config_showChart'] = 'Show Chart instead of bar?';
$string['config_showChart_help'] = 'Choose whether to show the completion bar or a chart generated by Moodle Chart API (Lose activity breakdown and links).';
...
$string['showchart'] = 'Show the completion progress as a chart.';
